GO ?= go
EXECUTABLE := bitbucketServer2Gitea
GOFILES := $(shell find . -type f -name "*.go")
TAGS ?=
LDFLAGS ?= -X 'github.com/appleboy/BitbucketServer2Gitea/cmd.Version=$(VERSION)' -X 'github.com/appleboy/BitbucketServer2Gitea/cmd.Commit=$(COMMIT)'
